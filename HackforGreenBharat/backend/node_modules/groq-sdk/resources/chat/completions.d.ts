...
export type ChatCompletionContentPart = ChatCompletionContentPartText | ChatCompletionContentPartImage | ChatCompletionContentPart.ChatCompletionRequestMessageContentPartDocument;
export declare namespace ChatCompletionContentPart {
    interface ChatCompletionRequestMessageContentPartDocument {
    ...
    namespace ChatCompletionRequestMessageContentPartDocument {
        interface Document {
            /**
...
export interface ChatCompletionCreateParamsBase {
     ...
     */
    model: (string & {}) | 'compound-beta' | 'compound-beta-mini' | 'gemma2-9b-it' | 'llama-3.1-8b-instant' | 'llama-3.3-70b-versatile' | 'meta-llama/llama-4-maverick-17b-128e-instruct' | 'meta-llama/llama-4-scout-17b-16e-instruct' | 'meta-llama/llama-guard-4-12b' | 'moonshotai/kimi-k2-instruct' | 'openai/gpt-oss-120b' | 'openai/gpt-oss-20b' | 'qwen/qwen3-32b';
    /**
...
export declare namespace CompletionCreateParams {
    ...
    namespace Document {
         ...
         */
        interface ChatCompletionDocumentSourceText {
            /**
         ...
         */
        interface ChatCompletionDocumentSourceJson {
            /**
